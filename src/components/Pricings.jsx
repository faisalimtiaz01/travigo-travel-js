    ...
    <div className='my-16 relative'>
        <div className='travigo-container '>
            <div className='grid items-center justify-items-center mb-11 md:mb-7 text-center gap-2 '>
                ...
                <div className='ring-1 ring-slate-100 rounded-full py-1.5 px-2 flex items-center justify-between gpa-5 my-5 shadow-md shadow-slate-200  '>
            ...
            <div className='grid items-center grid-cols-2 md:grid-cols-1 w-full mx-w-5xl md:max-w-md gap-9 lg:gap-5 m-auto'>
               {plans?.map((plan,i)=>(
